      ...
      <div className="TermsAndConditon">
        ...
        <div className="TermsAndConditionDesc">
          <p>
            ...
            use of PRAN's Website, located at https://www.pran.rajivranjan.me.
          </p>

          <p>
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use pran.rajivranjan.me if you do not
          ...
          <h3>Cookies</h3>
          <p>
            We employ the use of cookies. By accessing pran.rajivranjan.me, you
            agreed to use cookies in agreement with the PRAN's Privacy Policy.
          </p>
          <p>
          ...
          <h3>License</h3>
          <p>
            Unless otherwise stated, PRAN and/or its licensors own the
            intellectual property rights for all material on
            pran.rajivranjan.me. All intellectual property rights are reserved.
            You may access this from pran.rajivranjan.me for your own personal
            use subjected to restrictions set in these terms and conditions.
          </p>

          <h3>You must not:</h3>
          <p>
            Republish material from pran.rajivranjan.me
            <br />
            Sell, rent or sub-license material from pran.rajivranjan.me
            <br />
            Reproduce, duplicate or copy material from pran.rajivranjan.me
            <br />
            Redistribute content from pran.rajivranjan.me
            <br />
          ...
          <p>
            ...
            PRAN does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of PRAN,its agents and/or affiliates. Comments reflect the
            views and opinions of the person who post their views and opinions.
            To the extent permitted by applicable laws, PRAN shall not be liable
          ...
          <p>
            PRAN reserves the right to monitor all Comments and to remove any
          ...
          <p>
            ...
            <br />
            You hereby grant PRAN a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of PRAN; and (d)
          ...
          <p>
            ...
            sending an e-mail to PRAN. Please include your name, your
          ...
          <p>
            ...
            party's site.
            <br />
            No use of PRAN's logo or other artwork will be allowed for linking
          ...
          <p>
            ...
            website are provided free of charge, we will
          </p>
        </div>
      </div>
      <Footer/>
