...
{/* WHY CHOOSE US*/}
            ...
            <div className="whyChooseUs">
                ...
                <div className="box">
                    ...
                    <h2>Notes</h2>
                    <p>All Subjects hand Written notes in structured manner and in simplified language</p>
                </div>
                
                <div className="box">
                <img src={pyqImg} alt="pyq-img" />
                    <h2>PYQs</h2>
                    <p>All Subjects previous year question are available in structured manner.</p>
                </div>

                <div className="box">
                <img src={youtubeImg} alt="lecture-img" />
                    <h2>Lectures</h2>
                    <p>All Subjects with there respective units lectures are also available here.</p>
                </div>
            </div>
            ...
            <div className='Image-content-section'>
                <div className="Image-desc">
                    <p>PRAN an app for all types of study related requirements in Vinoba Bhave University (VBU) for the students of VBU. 
                   You Can also say it VBU students App.</p>
                </div>
            ...
            <div className="whyChooseUsBoxes">
                ...
                <img src={syllabusImg} alt="syllabus-img" />
                    <h2>Syllabus</h2>
                    <p>A syllabus of respective courses with respective semester are also available here.</p>
                </div>

                <div className="box">
                <img src={holidayImg} alt="holiday-img"  />
                    <h2>Holidays</h2>
                    <p>Holiday list circulated by VBU is also available and gets updated every year.</p>
                </div>
            </div>
            ...
            <div className='Image-content-section'>
                <div className="Image-desc">
                    <p>Perfect place for the VBU students. It is a like a guide to score good marks in examination. We believe in impact full Study and on regular basis revision.</p>
                </div>
