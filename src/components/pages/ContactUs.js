    ...
    <div className="ContactUs">
        ...
        <div className="ContactUsForm">
            <form>
                ...
                <input type='text' placeholder='Title:' name='title'/> <SlNote size="20px" color="#5B5B5B"/>
                </div>

                <div className="input-container">
                <input type='email' placeholder='E-mail:' name='email'/> <MdEmail size="25px" color="#5B5B5B"/>
                </div><br/>
