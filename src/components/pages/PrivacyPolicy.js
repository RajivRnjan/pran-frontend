...
function PrivacyPolicy() {
  return (
		<>
			<Helmet>
				<title>PRAN - Privacy Policy</title>
			</Helmet>
			<Navbar />
			<div className="PrivacyPolicy">
				...
				<div className="PrivacyPolicyDesc">
					<p data-aos="fade-up">
						At PRAN , accessible from our App, one of our main priorities is the
						privacy of our visitors. This Privacy Policy document contains types
						of information that is collected and recorded by PRAN and how we use
						it.
					</p>
					...
					<p data-aos="fade-up">
						...
						that they shared and/or collect in PRAN . This policy is not
					...
					<p data-aos="fade-up">
						PRAN follows a standard procedure of using log files. These files
					...
					<h3 data-aos="fade-up">Cookies and Web Beacons</h3>
					<p data-aos="fade-up">
						Like any other website, PRAN uses 'cookies'. These cookies are used
					...
					<h3 data-aos="fade-up">Our Advertising Partners</h3>
					<p data-aos="fade-up">
					...
					<h3 data-aos="fade-up">Advertising Partners Privacy Policies</h3>
					<p data-aos="fade-up">
						You may consult this list to find the Privacy Policy for each of the
						advertising partners of PRAN .
					</p>

					<p data-aos="fade-up">
						Third-party ad servers or ad networks uses technologies like
						cookies, JavaScript, or Web Beacons that are used in their
						respective advertisements and links that appear on PRAN , which are
						...
						<br />
						Note that PRAN has no access to or control over these cookies that
						are used by third-party advertisers.
					</p>

					<h3 data-aos="fade-up">Third Party Privacy Policies</h3>
					<p data-aos="fade-up">
						PRAN 's Privacy Policy does not apply to other advertisers or
					...
					<h3 data-aos="fade-up">GDPR Data Protection Rights</h3>
					<p data-aos="fade-up">
					...
					<p data-aos="fade-up">
						PRAN does not knowingly collect any Personal Identifiable
