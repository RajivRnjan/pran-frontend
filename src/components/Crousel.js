...
function Crousel() {
  return (
    ...
    <div className="card">
        ...
        <p>Beneficial for VBU students for study stuffs like notes,pyqs and notices. Thnx developer for developing this app?</p>
    </div>
    <div className="card">
        <div className="card-header">
        ...
        <p>Very useful application here all PYQ and notes are available which helps the student in analysing question pattern of upcoming examination...</p>
    </div>
    ...
    <div className="card">
        ...
        <p>This is very helpful app for me. I Got all my study materials in this app. I recommend this to all vbu students.</p>
    </div>
    <div className="card">
        <div className="card-header">
        ...
        <p>Awesome! Thanks for providing such educational app for all VBU students.</p>
    </div>
    ...
    <div className="card">
        ...
        <p>Great! All notes are available with previous year question and it serve elibrary book . All notice of vbu are informed on this app and it's notification are use for essential work.</p>
    </div>
